              ...
              SizedBox(
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final firstBarHeight =
                        scoreboardController.firstBarValue.value *
                        barChartHeight;
                    final secondBarHeight =
                        scoreboardController.secondBarValue.value *
                        barChartHeight;
                    ...
                    double firstBarTextTop =
                        firstBarTop + fixedTextOffsetFromBarTop;
                    double secondBarTextTop =
                        secondBarTop + fixedTextOffsetFromBarTop;

                    const double textHeight = 28;
                    if (firstBarHeight <
                        textHeight + fixedTextOffsetFromBarTop) {
