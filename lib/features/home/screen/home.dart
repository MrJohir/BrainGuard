          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: InkWell(
                  onTap: () {
                    Get.to(() => YesRelapsed(days: controller.dayValue));
                  },
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Obx(
                                () => Text(
                                  controller.motivationText.value.isEmpty
                                      ? 'tell us why you want to quit porn'
                                      : controller.motivationText.value,
                                  style: getTextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w400,
                                    color: Color(0xffFFFFFF),
                            ...
                            children: [
                              ...
                              Obx(
                                () => Padding(
                                  ...
                                  child: LinearProgressIndicator(
                                    borderRadius: BorderRadius.circular(10),
                                    value: controller.progressDecimalMood.value,
                                    backgroundColor: Color(0xff133663),
                                    valueColor: AlwaysStoppedAnimation<Color>(
                                      Color(0xff357BE1),
                                    ),
