                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Obx(
                                () => Slider(
                                  value: journalStatusController.moodSliderValue.value,
                                  min: 0.0,
                                  max: 1.0,
                                  divisions: 4,
                            ...
                            Column(
                              ...
                              children: [
                                Obx(() {
                                  final emoji = journalStatusController
                                      .moodList[journalStatusController.moodList
                                          .indexWhere((e) =>
                                              e['label'] ==
                                              journalStatusController.selectedMood.value)]['emoji'];
                                  return Text(
                                    emoji,
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Obx(
                                () => Slider(
                                  value: journalStatusController.urgeSliderValue.value,
                                  min: 0.0,
                                  max: 1.0,
                                  divisions: 4,
                                ...
                                Obx(() {
                                  final emoji = journalStatusController
                                      .moodList[journalStatusController.moodList
                                          .indexWhere((e) =>
                                              e['label'] ==
                                              journalStatusController.selectedUrge.value)]['emoji'];
                                  return Text(
                                    emoji,
                                    style: TextStyle(fontSize: 13),
                                  );
